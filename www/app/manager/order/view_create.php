...
<body>
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        <a id="back" href="/manager/order/index" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none" style="margin-left: 16px;">
    ...
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            ...
            btn_client_search.addEventListener('click', () => {
                ...
                xhr.open('POST', '/manager/order/search_client');
            ...
            btn_add_client.addEventListener('click', () => {
                let xhr = new XMLHttpRequest();
                xhr.open('POST', '/manager/order/add_client');
                xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.onload = () => {
                    if (xhr.status == 200) {
            ...
            */
            ...
            btn_car_search.addEventListener('click', () => {
                console.log(111);
                let xhr = new XMLHttpRequest();
                xhr.open('POST', '/manager/order/search_car');
                xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.onload = () => {
                    if (xhr.status == 200) {
            ...
            btn_add_car.addEventListener('click', () => {
                let xhr = new XMLHttpRequest();
                xhr.open('POST', '/manager/order/add_car');
                xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.onload = () => {
                    if (xhr.status == 200) {
            ...
            btn_save.addEventListener('click', () => {
                let xhr = new XMLHttpRequest();
                xhr.open('POST', '/manager/order/add');
                xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.send();
            ...
            /**
             * Функція для отримання всіх працівників СТО
             * 
             * @returns {void}
             */
            ...
            function create_order() {
                let xhr = new XMLHttpRequest();
                xhr.open('POST', '/manager/order/create_order');
                xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.onload = () => {
                    if (xhr.status == 200) {
                        let data = JSON.parse(xhr.response);
                        order_id = data[0].id;
                        document.getElementById('back').setAttribute('href', '/manager/order/delete/' + order_id)
                    }
                };
                xhr.send(post_str({
                    'client_id': client_id,
