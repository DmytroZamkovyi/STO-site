...
<body>
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <a href="/admin/order/index" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none" style="margin-left: 16px;">
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            btn_delete.addEventListener('click', () => {
                if (confirm('Ви дійсно хочете видалити це замовлення?')) {
                    window.location.href = '/admin/order/delete/' + '<?= $order_id ?>';
                }
            });
            ...
            btn_save.addEventListener('click', () => {
                ...
                let xhr = new XMLHttpRequest();
                xhr.open('POST', '/admin/order/update/' + '<?= $order_id ?>');
                xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.onload = () => {
                    if (xhr.status != 200) {
            ...
            /**
             * Функція для отримання списку завдання
             * 
             * @returns void
             */
            function get_task() {
